...
public class TemplateExecutor {
    ...
    public TemplateExecutor(HttpServletRequest request, HttpServletResponse response, ServletContext servletContext, Locale locale) {
        ...
        executor = new StaticTemplateExecutor(context, templateMode);
    }
